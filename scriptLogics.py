...
def pre_condition(file, bizlogic):
    file_name = str(file).replace(".biz", "Def.py")
    ...
    if method_name in dir(bld):
        ...
        definition = open(file_name, "a")
        definition.write("\n\n    def " + method_name+'(self):\n')
        definition.write("        pass")
        definition.close()


def actions(file, bizlogic, input_d):
    file_name = str(file).replace(".biz", "Def.py")
